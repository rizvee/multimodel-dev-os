  ...
  if (rawValue === undefined || rawValue === null || rawValue === '') {
    ...
    return {
      ...
      error: createExecutionError({
        ...
        message: 'Required environment credential is missing or unavailable',
        provider_id,
        redacted: true,
      }),
    };
  ...
  if (typeof rawValue !== 'string') {
    return {
      ...
      error: createExecutionError({
        ...
        code: 'credential_reference_invalid',
        category: 'credential_reference_invalid',
        message: 'Environment credential must be a string',
        provider_id,
        redacted: true,
      }),
    };
  ...
  if (rawValue.trim() === '') {
    ...
    return {
      ...
      error: createExecutionError({
        ...
        code: 'credential_unavailable',
        category: 'credential_unavailable',
        message: 'Environment credential cannot be whitespace-only',
        provider_id,
        redacted: true,
      }),
    };
  ...
  if (/[\x00\r\n]/.test(rawValue)) {
    return {
      ...
      error: createExecutionError({
        ...
        code: 'credential_reference_invalid',
        category: 'credential_reference_invalid',
        message: 'Environment credential contains illegal control characters',
        provider_id,
        redacted: true,
      }),
    };
  ...
  if (rawValue.length > 16384) {
    return {
      ...
      error: createExecutionError({
        ...
        code: 'credential_reference_invalid',
        category: 'credential_reference_invalid',
        message: 'Environment credential exceeds maximum allowed length of 16 KiB',
        provider_id,
        redacted: true,
      }),
    };
