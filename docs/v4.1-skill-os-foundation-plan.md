...
Sprint B adds validation for the Sprint A schema and registry layer. It does not execute automation, enforce permissions, or change public CLI behavior.
...
Sprint A adds the initial schema and example layer for v4.1. Sprint B validates that layer:
