...
v4.2 is the next development cycle after the v4.1 Skill OS Foundation release. The `main` branch uses package version `4.2.0-dev.0` for development-lane safety. This document is a planning guide; v4.2 is not released and no gateway runtime exists yet.
