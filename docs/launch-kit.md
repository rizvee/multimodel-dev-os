...
>
> The current release includes guided demo workflows, safe repo onboarding for existing projects, adapter sync across 10+ tools, a self-improvement engine with 12 safety gates, and 300+ quality checks.
>
...
The current release includes 5 guided demo workflows, safe repo onboarding, a self-improvement engine with 12 safety gates, and 300+ quality checks.
...
| **Quality** | 300+ verification checks, `doctor --release` alignment checks |
